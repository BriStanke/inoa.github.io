        ...
        <svg viewBox="0 0 720 520" className="w-full h-full" role="img" aria-label={t.hero.planTitle}
          ...
          <defs>
            <radialGradient id={gradientId}>
              {/* Warm sunlight — intentional exception to the six UI
                  colours. Must sit clearly warmer than the #E8E6E0
                  paper: near-white values disappear against it. */}
              <stop offset="0%"  stopColor="#E2C79A" stopOpacity="0.55" />
              <stop offset="60%" stopColor="#E2C79A" stopOpacity="0.28" />
              <stop offset="100%" stopColor="#E2C79A" stopOpacity="0" />
            </radialGradient>
          </defs>
